...
var recursionPowerOfTwo = function(n) {
    ...
    // 遞迴：將 n 除以 2 再檢查是否是四的次方
    return recursionPowerOfTwo(n / 2);
};

// 測試用例
console.log(recursionPowerOfTwo(-2));  // 輸出：false，因為負數不能是四的次方
console.log(recursionPowerOfTwo(0));   // 輸出：false，因為 0 不是四的次方
...
console.log(recursionPowerOfTwo(5));   // 輸出：false，因為 5 不是四的次方
console.log(recursionPowerOfTwo(20));  // 輸出：false，因為 20 不是四的次方
...
console.log(isPowerOfTwo(5));   // 輸出：false，因為 5 不是四的次方
console.log(isPowerOfTwo(20));  // 輸出：false，因為 20 不是四的次方
